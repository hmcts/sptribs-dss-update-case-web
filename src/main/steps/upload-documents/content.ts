...
export const cy = () => ({
  ...
  paragraph2:
    'You may want to submit other documents, files, or evidence that provides the Tribunal with more information about your case. - welsh',
  paragraph3:
    'This will depend on the nature of your appeal, application or claim. Specific examples can be found in your completed tribunal form. - welsh',
  ...
  caseRelevancySubTitle:
    'For each piece of additional information or evidence you are submitting, please state why it is relevant to your case. - welsh',
  ...
  guideText: "You can't upload executable (.exe), zip or other archive files due to virus risks. - welsh",
  titleForFile: 'Select documents to upload - welsh',
  uploadButton: 'Upload file - welsh',
  documentListLabel: 'Please explain why you feel this document is relevant to your case. - welsh',
  delete: 'Delete - welsh',
